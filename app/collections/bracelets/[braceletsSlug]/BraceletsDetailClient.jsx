'use client';
// app/collections/bracelets/[braceletsSlug]/BraceletsDetailClient.jsx
// ✅ All interactive logic lives here — 'use client' is fine here
            ...
            <div className="product-modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="share-input-group">
                    ...
                    <button
                        ...
                        className={copySuccess === 'Copied!' ? 'success' : ''}
                    >
                        {copySuccess || 'Copy'}
                    </button>
                </div>
...
export default function BraceletsDetailClient({ braceletsSlug }) {
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            ...
            try {
                const sessionKey = `product_${braceletsSlug}`;
                let passedData = null;

                // ✅ FIX: Safe storage reads
                try {
                ...
                try {
                    const slugRes = await fetch(`${API_URL}/api/products/slug/${braceletsSlug}`);
                    if (slugRes.ok) {
                ...
                // ✅ Fallback: fetch all bracelets and find by slug
                ...
                const foundProduct = allProducts.find((p) => {
                    ...
                    return titleSlug === braceletsSlug;
                });

                if (!foundProduct) throw new Error(`Product not found for slug: "${braceletsSlug}"`);
        ...
        fetchProduct();
    }, [braceletsSlug, fetchLatestStock]);
    ...
    useEffect(() => { setCurrentMediaIndex(0); }, [braceletsSlug]);
                    ...
                    <div className="tab-pane">
                        ...
                        <ul>
                            <li className="detail-item">
                                <strong>Type:</strong> Bracelets <span>{product.type}</span>
                            </li>
                            <li className="detail-item">
                                <strong>Purity:</strong> Gold Vermeil or 92.5 Sterling Silver
                            </li>
                            <li className="detail-item">
                                <strong>Gross Wt in Grms:</strong>{' '}
